def triton_test_data(current_env, secrets, passwords):
    ...
    if "triton" in current_env:
        ...
        ] = "13e94c56-ef52-4d01-9710-47e158e2cc21_api"
        tb_data["brnf_existing_acct_existing_devices_client_secret"] = secrets[
            tb_data["brnf_existing_acct_existing_devices_client_id"]
        ]
        tb_data[
            "harness_brownfield_account_parent_pcid"
        ] = "08300c1251ab11ec84290e1dba8b8e00"
        tb_data[
            "harness_brownfield_account_child_pcid"
        ] = "2bc33caa51a911ecb0f70e1dba8b8e00"
