...
def mira_test_data(current_env, secrets, passwords):
    ...
    if "mira" in current_env:
        ...
        tb_data["gf_nw_app_region"] = "eu-north"
        ...
        tb_data["brnf_service_subs_api_client_id"] = "695099ad-7716-4970-ae4a-b37e4f82c781_api"
        tb_data["brnf_service_subs_api_client_secret"] = secrets[tb_data["brnf_service_subs_api_client_id"]]

        # SERVICE-CENTRIC UI CONFIGURATION
        tb_data["brnf_sc_api_client_id"] = "swsc_client"
        tb_data["brnf_sc_api_client_secret"] = secrets[tb_data["brnf_sc_api_client_id"]]
        tb_data["brnf_sc_username"] = "hcloud203+kjjebvi@gmail.com"
        tb_data["brnf_sc_password"] = passwords[tb_data["brnf_sc_username"]]
        tb_data["brnf_sc_pcid"] = "771bfebef90811eda87e0ee2e1475faa"
        tb_data["brnf_sc_pcid_name"] = "kjjebvi"
        tb_data["brnf_sc_app_instance"] = "9cb411ee-5bc8-43b7-be2d-863b21b19b57"
        tb_data["brnf_sc_app_id"] = "6be1a454-48e1-40c7-a1f7-3d2c0417e24c"
        tb_data["brnf_sc_app_cid"] = "1b0ea49403fa11eeaf0b1678a169e9a4"
        tb_data["brnf_sc_compute_serial_subs_mgmt"] = "COM_H6KAZ"
        tb_data["brnf_sc_compute_partnumber_subs_mgmt"] = "MZWIQZI"
        tb_data["brnf_sc_storage_serial_subs_mgmt"] = "ST_3QL4X"
        tb_data["brnf_sc_storage_partnumber_subs_mgmt"] = "UXQNYEW"

        # CLASSIC UI CONFIGURATION
        # tb_data["brnf_sc_api_client_id"] = "695099ad-7716-4970-ae4a-b37e4f82c781_api"
        # tb_data["brnf_sc_api_client_secret"] = secrets[tb_data["brnf_sc_api_client_id"]]
        ...
        tb_data["tac_admin_password"] = passwords[tb_data["tac_admin_username"]]
        tb_data["tac_admin_pcid1"] = "c76633d8127511eca5121eea03ba3a0a"
        tb_data["tac_admin_pcid1_name"] = "HPE GreenLake Support"
        tb_data[
            "tac_existing_acct_existing_devices_username"
        ] = "hcloud203+fogvqrr@gmail.com"
        tb_data["tac_existing_acct_existing_devices_password"] = passwords[
            tb_data["tac_existing_acct_existing_devices_username"]
        ]
        tb_data[
            "tac_existing_acct_existing_devices_pcid1"
        ] = "597987f8cf9311edb8f2a243e89d56d8"
        tb_data["tac_existing_acct_existing_devices_pcid1_name"] = "fogvqrr"
        tb_data[
            "tac_existing_acct_existing_devices_pcid1_athena_f_folder"
        ...
        tb_data[
            "tac_existing_acct_existing_devices_pcid1_iap_eval_subs_key_assigned"
        ] = "E732C77524AF342319"
        tb_data[
            "tac_existing_acct_existing_devices_pcid1_gw_brim_subs_key_assigned"
        ] = "COGATEWAYCMEUPAPS14"
        tb_data[
            "tac_existing_acct_existing_devices_pcid1_sw_brim_subs_key"
        ] = "CTHSWITCHCMEUPAPS14"
        tb_data[
            "tac_existing_acct_existing_devices_pcid1_service_brim_subs_key"
        ] = "FLSP6SERTEST001"
        # comp
        tb_data[
            "brnf_existing_acct_existing_devices_comp_appid"
        ] = "ba9e8972-0169-4415-993a-81a0eeb328b2"
        tb_data[
            "brnf_existing_acct_existing_devices_comp_instance_id"
        ] = "d67454df-5068-4811-a72e-bbe0e3908e0f"
        tb_data[
            "brnf_existing_acct_existing_devices_comp_acid"
        ] = "6ff2e748cebe11ed9aeec6b701bb9a56"
        ...
        # SERVICE-CENTRIC UI CONFIGURATION
        # Existing account existing devices
        tb_data["brnf_existing_acct_existing_devices_username"] = "hcloud203+abfginp@gmail.com"
        tb_data["brnf_existing_acct_existing_devices_password"] = passwords[
            tb_data["brnf_existing_acct_existing_devices_username"]]
        tb_data["brnf_existing_acct_existing_devices_acct1"] = "abfginp"
        tb_data["brnf_existing_acct_existing_devices_pcid"] = "8a547b04f93b11ed9a882e46a5c76cf0"
        tb_data["brnf_existing_acct_existing_devices_appid"] = "65858496-324d-492e-b117-6cfbb10b90a4"
        tb_data["brnf_existing_acct_existing_devices_instance_id"] = "37539f93-d549-458f-9731-28974c910326"
        tb_data["brnf_existing_acct_existing_devices_acid"] = "8f6ead0c25bf11ee92abca3219b05b13"
        tb_data["brnf_existing_acct_existing_devices_iap_sn"] = "STIAPHCFRO"
        tb_data["brnf_existing_acct_existing_devices_iap_mac"] = "00:5F:EC:58:F4:88"
        tb_data["brnf_existing_acct_existing_devices_gw_sn"] = "STGWAZVWFO"
        tb_data["brnf_existing_acct_existing_devices_gw_mac"] = "00:78:BE:D0:3B:D0"
        tb_data["brnf_existing_acct_existing_devices_sw_sn"] = "STSWIHFSPC"
        tb_data["brnf_existing_acct_existing_devices_sw_mac"] = "00:DB:5D:55:B1:D2"
        tb_data["brnf_existing_acct_existing_devices_client_id"] = "37539f93-d549-458f-9731-28974c910326_api"
        tb_data["brnf_existing_acct_existing_devices_client_secret"] = "7d62e66aa3f611ec88a09a6970d55bbf"
        tb_data["brnf_existing_acct_existing_devices_iap_serial_subs_mgmt"] = "STIAP3TUEZ"
        tb_data["brnf_existing_acct_existing_devices_iap_part_no_subs_mgmt"] = "JW242AR"
        tb_data["brnf_existing_acct_existing_devices_iap_mac_subs_mgmt"] = "00:00:00:8F:FA:4C"
        tb_data["brnf_existing_acct_existing_devices_sw_serial_subs_mgmt"] = "STSWIBHH8Z"
        tb_data["brnf_existing_acct_existing_devices_sw_part_no_subs_mgmt"] = "JL255A"
        tb_data["brnf_existing_acct_existing_devices_sw_mac_subs_mgmt"] = "00:00:00:62:ED:CE"
        tb_data["brnf_existing_acct_existing_devices_gw_serial_subs_mgmt"] = "STGWAZ518L"
        tb_data["brnf_existing_acct_existing_devices_gw_part_no_subs_mgmt"] = "7005-RW"
        tb_data["brnf_existing_acct_existing_devices_gw_mac_subs_mgmt"] = "00:00:00:81:BE:F5"
        ...
        # Existing account new devices
        tb_data["brnf_existing_acct_new_devices_username"] = "hcloud203+kjjebvi@gmail.com"
        tb_data["brnf_existing_acct_new_devices_password"] = passwords[
            tb_data["brnf_existing_acct_new_devices_username"]]
        tb_data["brnf_existing_acct_new_devices_pcid1"] = "771bfebef90811eda87e0ee2e1475faa"
        tb_data["brnf_existing_acct_new_devices_pcid1_name"] = "kjjebvi"
        tb_data[
            "brnf_existing_acct_new_devices_pcid1_athena_f_folder"
        ] = "athena-f-7fd2832af90811eda00b22c9915c6e96"
        tb_data[
            "brnf_existing_acct_new_devices_app_instance"
        ] = "37539f93-d549-458f-9731-28974c910326"
        tb_data[
            "brnf_existing_acct_new_devices_app_id"
        ] = "65858496-324d-492e-b117-6cfbb10b90a4"
        tb_data[
            "brnf_existing_acct_new_devices_app_cid"
        ] = "7fd2832af90811eda00b22c9915c6e96"
        ...
        tb_data["brnf_existing_acct_new_devices_iap_lic_key"] = "EAAAAD34658D948898"
        tb_data["brnf_existing_acct_new_devices_gw_lic_key"] = "E014204A5269C4B769"
        tb_data["brnf_existing_acct_new_devices_sw_lic_key"] = "EB6DFBC76FF5748B88"
        ...
        # tb_data["brnf_existing_acct_existing_devices_client_id"] = "695099ad-7716-4970-ae4a-b37e4f82c781_api"
        # tb_data["brnf_existing_acct_existing_devices_client_secret"] = secrets[
        #     tb_data["brnf_existing_acct_existing_devices_client_id"]]
        # tb_data["brnf_existing_acct_existing_devices_api_client_id"] = "695099ad-7716-4970-ae4a-b37e4f82c781_api"
        ...
        # tb_data["brnf_existing_acct_new_devices_client_id"] = "695099ad-7716-4970-ae4a-b37e4f82c781_api"
        # tb_data["brnf_existing_acct_new_devices_client_secret"] = secrets[
        #     tb_data["brnf_existing_acct_new_devices_client_id"]]
        ...
        tb_data[
            "brnf_existing_acct2_new_devices_pcid1"
        ] = "779d097613f911eeb235ea371e477a75"
        tb_data["brnf_existing_acct2_new_devices_pcid1_name"] = "chpatzr"
        tb_data[
            "brnf_existing_acct2_new_devices_pcid1_athena_f_folder"
        ] = "athena-f-7fb5082013f911eebb4ddeaf5c210d4b"
        ...
        tb_data["brownfield_account_with_one_network_app"][
            "username"
        ] = "hcloud203+zpakuhn@gmail.com"
        tb_data["brownfield_account_with_one_network_app"][
            "pcid"
        ] = "6f01dbdacebb11ed859e5e2881d808e7"
        tb_data["brownfield_account_with_one_network_app"][
            "appid_network"
        ] = "65858496-324d-492e-b117-6cfbb10b90a4"
        tb_data["brownfield_account_with_one_network_app"][
            "app_instance_id_network"
        ] = "05a2fdd2-b91e-4a02-834f-262a88b4de43"
        tb_data["brownfield_account_with_one_network_app"][
            "pcid1_athena_f_folder"
        ...
        tb_data["brownfield_account_with_one_network_app"]["app_client_id"] = "695099ad-7716-4970-ae4a-b37e4f82c781_api"
        ...
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["account_name"] = "fpjtfmg"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["username"] = "hcloud203+fpjtfmg@gmail.com"
        ...
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["app_short_name_network"] = "VKJVKJ"
        ...
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["app_instance_id_network"] = \
            "95ee4239-e1d0-410f-b55d-ab5327c20c50"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["msp_pcid"] = "4be6c134f96c11eda10b8a41e44d087f"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["msp_pcid_name"] = "fpjtfmg"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["msp_acid_network"] = "76224f62324d11ee8117ea2ff394c004"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["tenant1_name"] = "fpjtfmg tenant1 acct"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["tenant1_pcid"] = "77005338308711eea98f8e49d8356205"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["tenant1_acid_network"] = \
            "8936614c324d11ee90a332a7e1982afd"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["tenant2_name"] = "fpjtfmg_tenant_2"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["tenant2_pcid"] = "a482be7e3a9911ee92a1ee32b1bd1c12"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["tenant2_acid_network"] = \
            "cbc3e3a03a9911ee9c2fbaa6e2f0dbae"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["tenant3_name"] = "fpjtfmg_ztp_tenant_1"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["tenant3_pcid"] = "43939b823a9a11ee91a7862c7c17acbb"
        tb_data["brownfield_msp1_with_three_tenants_and_app"]["tenant3_acid_network"] = \
            "6a92a70a3a9a11eeb02bde0f9479de9d"
