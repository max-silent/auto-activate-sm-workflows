...
from automation_svc_ui.tests.brownfield_existing_acct_existing_devices.existing_tac_acct_existing_devices \
...
@allure.suite("Greenfield TAC network devices - service_centric_ui")
@allure.sub_suite("Greenfield TAC existing account existing network devices")
