...
from automation_svc_ui.local_libs.login.app_api_login import AppApiSession
from automation_svc_ui.local_libs.login.user_api_login import UserApiLogin
...
class InitTestExistingDevicesUnassignDevicesAppApi:
    def __init__(self):
        ...
        # TODO: fix irrelevant non-existing keys
        ...
        # self.api_key = ExistingUserAcctDevices.test_data["brnf_existing_acct_existing_dynamic_devices"][
        #     "api_client_id_network"]
        # self.api_secret = ExistingUserAcctDevices.test_data["brnf_existing_acct_existing_dynamic_devices"][
        #     "api_client_secret_network"]
...
class TestExistingDevicesUnassignDevicesAppApiSvc:
    ...
    def test_assign_sm_eval_license(self):
        ...
        try:
            ...
            SMAssignments().wf_assign_subs_eval(device_type, serial, user_api_login_load_account)
            assert True
