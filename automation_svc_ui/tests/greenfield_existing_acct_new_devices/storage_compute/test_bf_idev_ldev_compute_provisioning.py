...
@allure.suite("Brownfield Idev Ldev compute device provision - service_centric_ui")
class TestBrownfieldComputeIdevLdevSvc:
    ...
    @pytest.mark.parametrize('serial, part, certs', [
        pytest.param("STCOMSER1", "STCOMPT1", "idev_ldev_success_certs", marks=pytest.mark.order(6),
                     id='success_scenario_C1337693'),
        pytest.param("STTFHIK", "STCOMPGYG", "idev_ldev_success_certs", marks=pytest.mark.order(7),
                     id='correct_cert_incorrect_apinfo_C1337694'),
        pytest.param("STCOMSER1", "STCOMPT1", "idev_ldev_non_existent_comp_certs", marks=pytest.mark.order(8),
                     id='incorrect_cert_correct_ap_info_C1337695'),
        # pytest.param("noapinfo", "", "idev_ldev_success_certs", marks=pytest.mark.order(9), id='correct_cert_no_apinfo_C1337696'),
        pytest.param("STCOMSER1", "STCOMPT1", "idev_ldev_incorrect_serial_certs", marks=pytest.mark.order(10),
                     id='incorrect_serial_correct_apinfo_C1337702')])
    ...
    @pytest.mark.parametrize('serial, part, certs', [
        ...
        pytest.param("STCOMSER1", "STCOMPTUNK1", "idev_ldev_incorrect_part_certs", marks=pytest.mark.order(14),
                     id='correct_serial_and_incorrect_part_C1337701'),
        pytest.param("STCOMSERUNK1", "STCOMPT1", "idev_ldev_incorrect_serial_certs", marks=pytest.mark.order(15),
                     id='incorrect_serial_and_correct_part_C1337700')])
