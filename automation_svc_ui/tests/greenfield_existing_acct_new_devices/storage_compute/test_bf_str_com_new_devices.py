...
@allure.suite("Brownfield storage compute devices - service_centric_ui")
@allure.sub_suite("Brownfield existing account new storage compute devices")
class TestClaimDeviceBetweenAcctsSvc:
    ...
    def test_claim_device_acc1_acc2_c1220631(self, brnf_app_api_session, adi_app_api_helper, order_sc_compute_devices):
        ...
        is_device_provisioned = adi_app_api_helper.is_device_provisioned_to_pcid(
            platform_customer_id=ExistingUserAcctDevices.test_data[
                "brownfield_account_with_one_network_app"]
        ...
        if is_device_provisioned:
            ...
            unassign_response = brnf_app_api_session.unprovision_device_from_application(payload=payload,
