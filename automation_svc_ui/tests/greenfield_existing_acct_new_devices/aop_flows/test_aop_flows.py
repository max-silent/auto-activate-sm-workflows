...
from automation_svc_ui.tests.greenfield_existing_acct_new_devices.aop_flows.aop_flow_cases import *
...
@allure.suite("Brownfield aop flow cases - service_centric_ui")
@allure.sub_suite("Brownfield aop flow order test cases for all device types")
class TestAopFlowCasesSvc:
