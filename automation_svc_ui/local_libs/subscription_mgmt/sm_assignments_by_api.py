...
from automation_svc_ui.configs.device_mappings.sm_mapping import SubsPartMap
...
from automation_svc_ui.tests.workflows.brownfield.networking.existing_acct_existing_devices. \
