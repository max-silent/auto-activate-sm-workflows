...
class ActivateBridgeUtils:
    ...
    def create_bridge_login(self, username, password_token, init_bridge_object):
        ...
        login_status, login_response = init_bridge_object.post_bridge_login(username=username,
    ...
    def create_folder(self, init_bridge_object, user_folder_name=None):
        ...
        :rtype: dict or bool
        """
        create_default_folder_status, create_default_folder_response = init_bridge_object.create_folder(
