...
from automation.conftest import get_add_device_expected_responses, ExistingUserAcctDevices
from automation.tests.workflows.greenfield.wf_session_new_user_acct_first_order_auto_claim import (
...
@allure.suite("Greenfield New Account New devices")
@pytest.mark.Plv
class TestGreenfieldNewAccountNewDevices:
    ...
    def test_verify_account_eval_subs_c1221585(self, new_user_login_load_account):
        ...
        """
        time.sleep(60)
        # add delay for account to get evals subscriptions
