import pytest
from automation.local_libs.activate_bridge.activate_bridge_utils import ActivateBridgeUtils
...
class TestActivateBridge:
    ...
    def test_inventory_query_with_limit_offset(self, init_bridge_object):
        ...
        inventory_query_status, inventory_query = create_test.inventory_query(action_param=action_param, limit=limit, offset=offset, init_bridge_object=init_bridge_object)
    ...
    def test_create_and_delete_folder(self, init_bridge_object):
        ...
        create_test = ActivateBridgeUtils()
        create_folder_status, create_folder_response = create_test.create_folder(user_folder_name=user_folder_name, init_bridge_object=init_bridge_object)
        ...
        if get_id:
            ...
            folder_status_code, folder_response = create_test.delete_created_folder(folderId=id, init_bridge_object=init_bridge_object)
    ...
    def test_get_all_folders_by_query(self, init_bridge_object):
        ...
        """
        create_test = ActivateBridgeUtils()
        get_folder_by_query_status, get_folder_by_query = create_test.get_all_folders_by_query(init_bridge_object=init_bridge_object)
