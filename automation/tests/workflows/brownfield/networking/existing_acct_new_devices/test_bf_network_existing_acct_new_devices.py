...
from automation.conftest import SkipTest, get_add_device_expected_responses
from automation.local_libs.activate_inventory.verify_by_api import VerifyByApi
from automation.local_libs.utils.pytest.pytest_marker import get_pytest_marker
...
class TestExistingAccountNewDevices:
    @pytest.mark.testrail(id=1220580)
    @pytest.mark.order(1)
    @pytest.mark.Regression
    @pytest.mark.Regression_Secondary
    @pytest.mark.Plv_Secondary
    @pytest.mark.Plv
    ...
    def test_brnf_user_login_load_account_c1441433(self, brnf_sa_user_login_load_account):
        """
    ...
    def test_assign_iap_device_c1220626(self, brnf_sa_order_iap_devices,
                               brnf_sa_user_login_load_account):
        """
    ...
    @pytest.mark.testrail(id=1220663)
    @pytest.mark.Plv
    @pytest.mark.Regression
    ...
    @pytest.mark.testrail(id=1220668)
    @pytest.mark.Plv
    @pytest.mark.Regression_Secondary
    @pytest.mark.Plv_Secondary
    @pytest.mark.Regression
    @pytest.mark.order(19)
    def test_get_devices_by_acid_iap_c1220668(self,
                                              brnf_sa_user_login_load_account,
        ...
        SkipTest.skip_if_triton_lite()
        Regression_Secondary = False
        if "Secondary" in request.session.config.option.markexpr:
            Regression_Secondary = True
        """
    ...
    def test_get_devices_by_pcid_iap_c1220651(self,
                                              brnf_sa_user_login_load_account,
                                              brnf_app_api_session,
                                              brnf_sa_order_iap_devices,
                                              request
    ...
    def test_get_sm_by_acid_c1220667(self, brnf_sa_user_login_load_account, request):
        Regression_Secondary = False
        if "Secondary" in request.session.config.option.markexpr:
            Regression_Secondary = True
        """
    ...
    @pytest.mark.testrail(id=1220669)
    @pytest.mark.Plv
    @pytest.mark.Regression
    @pytest.mark.Regression_Secondary
    @pytest.mark.Plv_Secondary
    @pytest.mark.order(24)
    def test_get_sm_by_pcid_c1220669(self, brnf_sa_user_login_load_account, request):
        SkipTest.skip_if_triton_lite()
        Regression_Secondary = False
        if "Secondary" in request.session.config.option.markexpr:
            Regression_Secondary = True
