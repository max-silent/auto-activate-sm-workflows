...
@pytest.mark.skipif("triton-lite" in ExistingUserAcctDevices.login_page_url, reason="No test TAC-user on triton-lite.")
@allure.parent_suite("activate-sm-workflows")
@allure.suite("Brownfield network devices")
@pytest.mark.Plv
@allure.sub_suite("Brownfield existing msp account new network devices")
class TestExistingMspAccountNewDevices:
    ...
    @pytest.mark.parametrize('api_path, x_type', [
        pytest.param("hpe-provision", "provision-update",
                     marks=[pytest.mark.testrail(id=1313773), pytest.mark.order(6)],
                     id='ftpm_provision_C1313773'),
        pytest.param("hpe-provision-rtpm", "provision-update",
                     marks=[pytest.mark.testrail(id=1342982), pytest.mark.order(7)],
                     id='rtpm_provision_C1342982'),
        pytest.param("cx-provision", "provision-update", marks=[pytest.mark.testrail(id=1313775), pytest.mark.order(8)],
    ...
    @pytest.mark.parametrize("endpoint, x_type, fw_version", [
        pytest.param("/firmware", "firmware-check", "8.4.0.0-8.4.0.0_70043",
                     marks=[pytest.mark.testrail(id=1313788), pytest.mark.order(13)], id="firmware-check_C1313788"),
        pytest.param("/firmware", "firmware-baseversion-iap", "8.5.0.5-8.5.0.5_73491",
                     marks=[pytest.mark.testrail(id=1313790), pytest.mark.order(14)],
                     id="firmware-baseversion-iap_C1313790"),
        pytest.param("/firmware", "firmware-baseversion-gateway", "8.5.0.5-8.5.0.5_73491",
                     marks=[pytest.mark.testrail(id=1313791), pytest.mark.order(15)],
                     id="firmware-baseversion-gateway_C1313791"),
        pytest.param("/firmware", "firmware-upgrade", "8.4.0.0-8.4.0.0_70043",
                     marks=[pytest.mark.testrail(id=1313789), pytest.mark.order(16)], id="firmware-upgrade_C1313789")])
    ...
    @pytest.mark.parametrize('api_path, x_type', [
        pytest.param("hpe-provision", "provision-update",
                     marks=[pytest.mark.testrail(id=1220688), pytest.mark.order(18)],
                     id='ftpm_provision_C1220688'),
        pytest.param("hpe-provision-rtpm", "provision-update",
                     marks=[pytest.mark.testrail(id=1342983), pytest.mark.order(19)],
                     id='rtpm_provision_C1342983'),
        pytest.param("cx-provision", "provision-update",
                     marks=[pytest.mark.testrail(id=1220690), pytest.mark.order(20)],
    ...
    @pytest.mark.testrail(id=1220580)
    @pytest.mark.parametrize('api_path, x_type', [
        pytest.param("hpe-firmware", "firmware-check", marks=[pytest.mark.testrail(id=1313792), pytest.mark.order(21)],
                     id='ftpm_firmware_check_C1313792'),
        pytest.param("hpe-firmware-rtpm", "firmware-check",
                     marks=[pytest.mark.testrail(id=1314054), pytest.mark.order(22)],
    ...
    @pytest.mark.parametrize("endpoint, x_type, fw_version", [
        pytest.param("/firmware", "firmware-baseversion-iap", "8.5.0.5-8.5.0.5_73491",
                     marks=[pytest.mark.testrail(id=1313794), pytest.mark.order(24)],
                     id="firmware-baseversion-iap_C1313794"),
        pytest.param("/firmware", "firmware-baseversion-gateway", "8.5.0.5-8.5.0.5_73491",
                     marks=[pytest.mark.testrail(id=1313795), pytest.mark.order(25)],
