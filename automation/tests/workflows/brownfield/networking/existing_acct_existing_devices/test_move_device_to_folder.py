...
from automation.tests.workflows.brownfield.networking.existing_acct_existing_devices.network_existing_device_test_helper \
...
class TestMoveDeviceToFolder:
    ...
    def test_move_device_to_folder_for_platform_customer_C1220650(self, adi_app_api_session):
        ...
        is_device_assigned = ExistingAccountExistingNetworkDeviceHelper.is_device_provisioned_to_acid_for_pcid(adi_app_api_session, pcid, acid, serial_number)
