...
from automation.tests.workflows.brownfield.networking.existing_tac_acct_existing_devices \
...
@allure.suite("Brownfield TAC network devices")
@allure.sub_suite("Brownfield TAC existing account existing network devices")
@pytest.mark.Plv
class TestExistingTACAccountExistingDevices:
    ...
    # This is kindred TestRail case ID.
