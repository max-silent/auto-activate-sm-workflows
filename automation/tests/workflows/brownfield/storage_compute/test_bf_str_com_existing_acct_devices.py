...
@pytest.mark.Plv
class TestBrownfieldStorageComputeNewDevices:
    @pytest.mark.order(1)
    ...
    @pytest.mark.Regression
    def test_brnf_sc_user_login_load_account_c1441433(self, brnf_sa_sc_user_login_load_account):
        """
    ...
    @pytest.mark.testrail(id=1220609)
    @pytest.mark.Regression
    def test_sm_subs_hciaas_new_subscription_key_reverse_order_dev_subs_c1220609(self,
                                                                                 brnf_sa_new_brim_subs_hciaas_baas_two,
                                                                                 brnf_sa_sc_user_login_load_account,
                                                                                 device_type="STORAGE", reverse=True):
        """
          ===== Assign BRIM license to COMPUTE device ======
          1. Using the login session
          2. Create new subscription for HCIaaS, with devices, add new sub to account
        ...
        if brnf_sa_sc_user_login_load_account:
            assert SMAssignments.wf_create_new_gecko_subscription_assign_to_device(
                device_type=device_type, brnf_sa_new_brim_subs_device=brnf_sa_new_brim_subs_hciaas_baas_two,
                brnf_sa_user_login_load_account=brnf_sa_sc_user_login_load_account, reverse=reverse)
