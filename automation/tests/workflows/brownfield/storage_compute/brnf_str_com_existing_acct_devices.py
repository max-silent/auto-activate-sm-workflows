...
class WfScExistingAcctDevices:
    ...
    def existing_acct_sc_create_device_fn(self, device_type, devices_count=1, lic_devices=None):
        ...
        return ManufactureDevicesHelper(aop_client, aop_secret, self.dev_constants) \
            .create_device_of_type(device_type, devices_count, lic_devices=lic_devices)
