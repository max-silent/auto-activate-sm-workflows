...
def pavo_test_data(current_env, secrets, passwords):
    ...
    if "pavo" in current_env:
        ...
        tb_data["gf_nw_api_client_id"] = "b87b5d9c-0e83-499a-9cb7-19d84d9643d5_api"
        tb_data["gf_nw_api_client_secret"] = secrets[tb_data["gf_nw_api_client_id"]]
        tb_data["gf_nw_app_id"] = "97ea1298-db08-4244-818f-2c11ef33396e"
        ...
        tb_data["tac_admin_username"] = "glcpsa2023fts@gmail.com"
        tb_data["tac_admin_password"] = \
            passwords[tb_data["tac_admin_username"]]
        tb_data["tac_admin_pcid1"] = "08a836d4127611ec8a1ae2e029c20432"
        tb_data["tac_admin_pcid1_name"] = "HPE GreenLake Support"
        tb_data["tac_existing_acct_existing_devices_username"] = "hcloud203+gyvtubr@gmail.com"
        tb_data["tac_existing_acct_existing_devices_password"] = \
            passwords[tb_data["tac_existing_acct_existing_devices_username"]]
        tb_data["tac_existing_acct_existing_devices_pcid1"] = "36799a1a5d4411ee98634e188b75e727"
        tb_data["tac_existing_acct_existing_devices_pcid1_name"] = "gyvtubr"
        tb_data["tac_existing_acct_existing_devices_pcid1_athena_f_folder"] = \
            "athena-f-427145525d4411ee82d81abc4a64aa99"
        tb_data["tac_existing_acct_existing_devices_pcid1_iap_sn"] = "STIAPTXS5K"
        tb_data["tac_existing_acct_existing_devices_pcid1_iap_part_no"] = "JW242AR"
        tb_data["tac_existing_acct_existing_devices_pcid1_iap_mac"] = "00:02:D5:05:45:12"
        tb_data["tac_existing_acct_existing_devices_pcid1_gw_sn"] = "STGWAKHPZ5"
        tb_data["tac_existing_acct_existing_devices_pcid1_gw_part_no"] = "7005-RW"
        tb_data["tac_existing_acct_existing_devices_pcid1_gw_mac"] = "00:3F:47:42:22:F9"
        tb_data["tac_existing_acct_existing_devices_pcid1_sw_sn"] = "STSWI8HGAS"
        tb_data["tac_existing_acct_existing_devices_pcid1_sw_part_no"] = "JL255A"
        tb_data["tac_existing_acct_existing_devices_pcid1_sw_mac"] = "00:62:40:76:4C:62"
        tb_data["tac_existing_acct_existing_devices_pcid1_iap_eval_subs_key_assigned"] = "EE1B0BDED7F2043BBB"
        tb_data["tac_existing_acct_existing_devices_pcid1_gw_brim_subs_key_assigned"] = "89030584503038612322"
        tb_data["tac_existing_acct_existing_devices_pcid1_sw_brim_subs_key"] = "53465178876036946897"
        tb_data["tac_existing_acct_existing_devices_pcid1_service_brim_subs_key"] = "YGJEEECGAU9H"
        ...
        tb_data["brnf_existing_acct_new_devices_pcid1_athena_f_folder"] = "athena-f-27cf93403cdb11eea867f27c3df0c6e2"
        ...
        tb_data["brnf_existing_acct_new_devices_pcid1_athena_f_folder"] = "athena-f-27cf93403cdb11eea867f27c3df0c6e2"
        tb_data["brnf_existing_acct_new_devices_iap_lic_key"] = "E74E4F961334346C1B"
        tb_data["brnf_existing_acct_new_devices_gw_lic_key"] = "E02970AA02C0143558"
        tb_data["brnf_existing_acct_new_devices_sw_lic_key"] = "EB8076FC536BA4ECDA"

        tb_data["brnf_existing_acct2_new_devices_username"] = "hcloud203+eciypdn@gmail.com"
        tb_data["brnf_existing_acct2_new_devices_password"] = passwords[
            tb_data["brnf_existing_acct2_new_devices_username"]]
        tb_data["brnf_existing_acct2_new_devices_pcid1"] = "6a00f4765ed111eea79e4e188b75e727"
        tb_data["brnf_existing_acct2_new_devices_pcid1_name"] = "eciypdn"
        ...
        devices_details_path = \
            os.path.join(AUTOMATION_DIRECTORY, "configs", "devices_data", "device_files", "pavo_50_devices.json")
        log.info(f"Resolved path to 'pavo_50_devices.json': {devices_details_path}")
        with open(devices_details_path, "r") as pavo_devices:
            tb_data["brnf_existing_acct_devices_list"] = json.load(pavo_devices)
        devices_details_path = \
            os.path.join(AUTOMATION_DIRECTORY, "configs", "devices_data", "device_files",
                         "pavo_3_athena_f_devices.json")
        log.info(f"Resolved path to 'pavo_3_athena_f_devices.json': {devices_details_path}")
        with open(devices_details_path, "r") as pavo_devices:
            tb_data["brnf_existing_acct_athena_f_devices_list"] = json.load(pavo_devices)
